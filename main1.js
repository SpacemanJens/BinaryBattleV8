...
function preload() {
  partyConnect("wss://p5js-spaceman-server-29f6636dfb6c.herokuapp.com", "jkv-BinaryBattleV8");
...
function setup() {
  ...
  fixedPlanet = new FixedPlanet(x = 300, y = 300, r = 200, color = [0, 0, 255]);
...
function moveMe() {
  ...
  if (fixedPlanet.onPlanet(xTemp + newGlobalX, yTemp + newGlobalY)) {
